...
export const frenchTranslations: Record<string, string> = {
    ...
    'milestone.badge': 'Jalon débloqué',
    'milestone.progress': 'Collection',
    'milestone.continue': 'Continuer',
    'milestone.first_set.title': 'Première série',
    'milestone.first_set.body': 'Tu as commencé le suivi. Chaque série prépare la semaine suivante.',
    'milestone.first_day.title': 'Séance terminée',
    'milestone.first_day.body': 'Journée complète. Finis la semaine pour débloquer la suite.',
    'milestone.week2.title': 'Semaine 2 débloquée',
    'milestone.week2.body': 'Premier microcycle terminé. Nouveaux objectifs prêts.',
    'milestone.three_days.title': 'Trois jours complétés',
    'milestone.three_days.body': 'Tu as validé trois jours différents. La régularité s\u2019installe.',
    'milestone.week4.title': 'Semaine 4 débloquée',
    'milestone.week4.body': 'Le bloc hypertrophie avance. Continue d\u2019enregistrer chaque série.',
    'milestone.deload.title': 'Semaine de décharge',
    'milestone.deload.body': 'Mi parcours. Récupère bien et reste précis.',
    'milestone.strength.title': 'Phase force',
    'milestone.strength.body': 'Moins de reps. Plus d\u2019intention. Fais confiance au plan.',
    'milestone.peak.title': 'Phase de pic',
    'milestone.peak.body': 'Fenêtre d\u2019intensité max. Atteins tes cibles proprement.',
    'milestone.retest.title': 'Semaine de retest',
    'milestone.retest.body': 'Mesure les lifts clés et vois le chemin parcouru.',
    'milestone.complete.title': 'Programme terminé',
    'milestone.complete.body': 'Douze semaines terminées. Habitude et chiffres sont là.',
    'milestone.feedLabel': 'Jalons',
